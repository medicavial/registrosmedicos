    ...
    if(!$db) {
        ...
        if ($temporal->execute()){
            ...
            if ($usuariocomercial) {
                ...
                $sql = "SELECT UNI_nombreMV FROM Unidad WHERE Uni_clave = $unidad";
                foreach ($db->query($sql) as $row) {
                    $nombreUnidad = $row['UNI_nombreMV'];
                }

                $sql = "SELECT Cia_nombrecorto FROM Compania WHERE Cia_clave = $empresa";
                foreach ($db->query($sql) as $row) {
                    $nombreEmpresa = $row['Cia_nombrecorto'];
                }
                ...
                $contenido = generaTabla($clave,$fecha,$nombreEmpresa,$nombreUnidad,$lesionado,$edad,$medico,$diagnostico,$nombreComercial);
...
function generaTabla($clave,$fecha,$nombreEmpresa,$nombreUnidad,$lesionado,$edad,$medico,$diagnostico,$nombreComercial){
